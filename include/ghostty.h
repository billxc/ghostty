...
typedef enum {
  ...
  GHOSTTY_ACTION_SIDEBAR_PREV_PROJECT,
  GHOSTTY_ACTION_SIDEBAR_NEXT_PROJECT,
  GHOSTTY_ACTION_SIDEBAR_PREV_TAB,
  GHOSTTY_ACTION_SIDEBAR_NEXT_TAB,
  GHOSTTY_ACTION_TOGGLE_PROJECT_SIDEBAR,
  GHOSTTY_ACTION_NEW_CLAUDE_TAB,
  GHOSTTY_ACTION_NEW_LAZYGIT_TAB,
  GHOSTTY_ACTION_PROMPT_AI_TOOL,
